          ...
          {isEditing ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center gap-3">
                <input
                  type="checkbox"
                  id="notifyOnRequestFulfilled"
                  checked={formData.notifyOnRequestFulfilled}
                  onChange={(e) =>
                    setFormData({ ...formData, notifyOnRequestFulfilled: e.target.checked })
                  }
                  className="w-5 h-5"
                />
              ...
              <div className="flex items-center gap-3">
                <input
                  type="checkbox"
                  id="notifyOnFeatureAlerts"
                  checked={formData.notifyOnFeatureAlerts}
                  onChange={(e) =>
                    setFormData({ ...formData, notifyOnFeatureAlerts: e.target.checked })
                  }
                  className="w-5 h-5"
                />
